package kr.co.core.money_tech.server.netUtil;
...
import kr.co.core.money_tech.server.CustomLoading;
import kr.co.core.money_tech.server.inter.OnAfterConnection;
import kr.co.core.money_tech.server.inter.OnParsingResult;
...
//                }
    ...
    public void setTag(String TAG) {
        this.TAG = TAG;
        Log.d(StringUtil.TAG, TAG + " Put Info");
    }
    ...
    public void addParams(String key, String value) {
        ...
        if(!StringUtil.isNull(value))
            Log.d(StringUtil.TAG, "key: " + key + ", value: " + value);
        else
            Log.d(StringUtil.TAG, "key: " + key + ", value: null");
    }
